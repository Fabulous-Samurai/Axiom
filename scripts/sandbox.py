...
def run_isolated_expression(expression):
    ...
    # What: Restrict eval() globals and locals to prevent arbitrary code execution.
    # Why: Without restricting built-ins, an attacker can use __import__ to bypass subprocess isolation.
    code = "print(eval(%s, {'__builtins__': {}}, {}))" % repr(expression)
