...
def run_isolated_expression(expression):
    ...
    # What: Restrict eval() environment using a safe whitelist for __builtins__.
    # Why: Prevents arbitrary code execution (like __import__('os')) while allowing standard math.
