...
def run_isolated_expression(expression):
    ...
    # What: Restrict eval() environment to prevent arbitrary code execution.
    # Why: Using eval() without restricting __builtins__ allows for sandbox escapes (e.g., via __import__).
    code = "print(eval(%r, {'__builtins__': {}}, {}))" % expression
