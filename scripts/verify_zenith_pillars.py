...
EXEMPT_FILES = ["main.cpp", "setup_other_device", "test_", "parser", "engine.cpp", "bridge.cpp", "ingress.cpp", "telemetry.cpp", "crash_dump.cpp", "unit_manager.cpp", "cpu_optimization.cpp", "dynamic_calc.cpp", "node_dispatcher.cpp", "python_repl.cpp", "statistics_engine.cpp"]
