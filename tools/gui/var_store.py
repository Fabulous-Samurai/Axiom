...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        self._flush_write_buf()
        # ⚡ Bolt: Using direct cursor iteration is highly optimized at the C level.
        # This avoids materializing intermediate rows into a list via .fetchall(),
        # reducing intermediate tuple list allocations and peak memory usage.
