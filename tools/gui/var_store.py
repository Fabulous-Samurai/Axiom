...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: Prevents unnecessary intermediate tuple list allocations, reducing peak memory usage.
        # Impact: Reduces memory footprint when retrieving keys capped at TABLE_VIEW_CAP.
