...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        self._flush_write_buf()
        # ⚡ BOLT OPTIMIZATION:
        # What: Replace .fetchall() with direct cursor iteration.
        # Why: .fetchall() materializes all intermediate rows into a list, increasing peak memory usage. Direct iteration yields rows lazily.
        # Impact: Reduces memory overhead and allocations when extracting keys, especially for large TABLE_VIEW_CAP sizes.
