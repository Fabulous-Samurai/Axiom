...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        self._flush_write_buf()
        # Optimization: use direct cursor iteration instead of .fetchall() to avoid
        # materializing intermediate rows into a list, saving memory and improving performance.
