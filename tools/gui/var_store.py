...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        self._flush_write_buf()
        # ⚡ BOLT OPTIMIZATION:
        # What: Avoid using .fetchall() and instead iterate over the cursor directly.
        # Why: .fetchall() materializes intermediate rows into a list of tuples, wasting memory and CPU time. Direct cursor iteration prevents this unnecessary allocation.
        # Impact: Reduces peak memory usage and improves performance when fetching large result sets.
