...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() materializes an intermediate list of tuples in memory, doubling peak memory usage.
        # Impact: Reduces memory overhead and peak allocation when retrieving up to 100,000 keys.
