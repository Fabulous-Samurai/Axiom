...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        self._flush_write_buf()
        # ⚡ BOLT OPTIMIZATION:
        # What: Use direct cursor iteration instead of .fetchall()
        # Why: Prevents unnecessary intermediate tuple list allocations for large query results.
        # Impact: Reduces peak memory usage and avoids redundant list allocation overhead.
