...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() materializes intermediate rows into a list, increasing peak memory usage. Direct cursor iteration avoids unnecessary intermediate tuple list allocations.
        # Impact: Reduces peak memory allocation overhead during iteration.
