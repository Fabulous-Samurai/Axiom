...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() allocates a large intermediate list of tuples in memory. Iterating directly over the cursor avoids this intermediate allocation.
        # Impact: Reduces peak memory usage when fetching keys from the SQLite table.
