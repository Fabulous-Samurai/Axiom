...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() allocates an intermediate list of tuples in memory, whereas direct cursor iteration is highly optimized at the C level.
        # Impact: Eliminates secondary list allocations, significantly reducing peak memory usage and improving execution time.
