...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() materialized up to TABLE_VIEW_CAP intermediate tuples in memory before they were parsed.
        # Impact: Reduces peak memory allocations during keys() calls by ~50% (avoids allocating the intermediate list of tuples).
