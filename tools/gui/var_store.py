...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # ⚡ BOLT OPTIMIZATION:
        # What: Direct cursor iteration instead of .fetchall()
        # Why: Avoids large intermediate list of tuples memory allocation.
        # Impact: Uses less peak memory and is faster when keys are large.
