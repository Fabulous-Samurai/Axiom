...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() materializes intermediate rows into a list of tuples, which increases memory overhead.
        # Impact: Reduces peak memory usage when fetching a large number of keys.
