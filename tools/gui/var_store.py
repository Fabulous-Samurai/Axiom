...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() allocates an intermediate list of tuples for all returned rows before unpacking.
        # Impact: Reduces peak memory usage and slightly improves throughput for large query results.
