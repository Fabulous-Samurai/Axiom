...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        return [r[0] for r in cursor]  # ⚡ Bolt: Use direct cursor iteration instead of fetchall() to avoid intermediate list allocation, improving speed and reducing peak memory usage.
