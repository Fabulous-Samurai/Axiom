...
class LargeScaleVarStore:
    ...
    def keys(self):
        ...
        # Why: .fetchall() materializes intermediate rows into a list, causing unnecessary allocations.
        # Impact: Reduces peak memory usage and improves performance when fetching large number of keys.
