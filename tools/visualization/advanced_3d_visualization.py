...
class Advanced3DVisualization:
    ...
    def surface_plot_3d(self, func_str=DEFAULT_SURFACE_FUNC, 
        ...
        try:
            ...
            Z = secure_eval(func_str, safe_dict)
    ...
    def parametric_3d_plot(self, x_func=DEFAULT_PARAMETRIC_X, y_func=DEFAULT_PARAMETRIC_Y, z_func=DEFAULT_PARAMETRIC_Z, 
        ...
        try:
            ...
            x = secure_eval(x_func, safe_dict)
            y = secure_eval(y_func, safe_dict)
            z = secure_eval(z_func, safe_dict)
    ...
    def animated_3d_surface(self, base_func=DEFAULT_SURFACE_FUNC, 
        ...
        try:
            ...
            z_base = secure_eval(base_func, safe_dict)
            time_mod = secure_eval(time_modulation, safe_dict)
            Z = z_base * time_mod
    ...
    def interactive_3d_plot(self, func_str="sin(x)*cos(y)"):
        ...
        try:
            ...
            def update_surface():
                ...
                Z = amplitude * secure_eval(func_str, safe_dict)
                return Z
    ...
    def create_3d_gui(self):
        ...
        def plot_parametric():
            try:
                ...
                # Parse t range
                t_min, t_max = secure_eval(f"({t_range_str})", {"pi": np.pi})
                t_range = (t_min, t_max)
