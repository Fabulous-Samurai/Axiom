...
namespace AXIOM
{
    ...
    {
        // ⚡ BOLT OPTIMIZATION:
        // What: Change local consts to static consts
        // Why: Calling std::getenv on every expression evaluation is incredibly slow.
        // Impact: Reduces overhead of AssessExpressionPolicy from ~300ns to ~3ns per call.
