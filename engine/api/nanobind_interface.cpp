...
nb::ndarray<nb::numpy, double, nb::ndim<2>> NanobindInterface::ConvertToNumPyMatrix(
    ...
    return MeasureCall("ConvertToNumPyMatrix", [&]() -> nb::ndarray<nb::numpy, double, nb::ndim<2>> {
        ...
        // Why: Nested std::vector causes O(rows) allocations and memory fragmentation.
        // Impact: Eliminates significant allocation overhead, improving conversion performance.
