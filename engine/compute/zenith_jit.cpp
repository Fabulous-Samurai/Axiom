...
#if defined(ASMJIT_BUILD_X86)
void ZenithJIT::CompileNodeX86(asmjit::x86::Compiler& cc, asmjit::x86::Gp vars_ptr, NodePtr node,
    ...
    std::visit([&](auto& n) {
        ...
        if constexpr (std::is_same_v<T, NumberNode>) {
            ...
            switch (n.op) {
                ...
                case '*': cc.vmulsd(out, left_res, right_res); break;
                case '/': cc.vdivsd(out, left_res, right_res); break;
            }
        }
