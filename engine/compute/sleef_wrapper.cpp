...
// Sleef_sind4_u10advsimd typically uses a custom struct to hold 4 doubles (2x128-bit)
void axiom_sleef_sin_d4(const double* in, double* out) {
    float64x2x2_t vin;
...
void axiom_sleef_sin_d4(const double* in, double* out) { for(int i=0; i<4; ++i) out[i] = std::sin(in[i]); }
void axiom_sleef_cos_d4(const double* in, double* out) { for(int i=0; i<4; ++i) out[i] = std::cos(in[i]); }
void axiom_sleef_tan_d4(const double* in, double* out) { for(int i=0; i<4; ++i) out[i] = std::tan(in[i]); }
void axiom_sleef_log_d4(const double* in, double* out) { for(int i=0; i<4; ++i) out[i] = std::log(in[i]); }
void axiom_sleef_log10_d4(const double* in, double* out) { for(int i=0; i<4; ++i) out[i] = std::log10(in[i]); }
void axiom_sleef_exp_d4(const double* in, double* out) { for(int i=0; i<4; ++i) out[i] = std::exp(in[i]); }
#endif
