...
public:
    ...
    /**
     * @brief High-performance dispatch with optional GPU offloading via Vulkan SSBO.
     */
    EngineResult DispatchOperation(std::string_view operation, 
     ...
     */
    EngineResult DispatchMatrixOperation(std::string_view operation, 
