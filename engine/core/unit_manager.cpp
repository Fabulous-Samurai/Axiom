...
void UnitManager::RegisterUnit(std::string_view symbol, UnitType type,
                               double scale, std::string_view name) noexcept {
  units_.emplace_back(type, scale, symbol, name);
}

EngineResult UnitManager::ConvertUnit(double value, std::string_view from_unit,
...
AXIOM::EngineResult UnitManager::ConvertTemperature(
    double value, std::string_view from_unit,
    std::string_view to_unit) noexcept {
...
bool UnitManager::AreCompatible(std::string_view unit1,
                                std::string_view unit2) noexcept {
...
AXIOM::FixedVector<std::string_view, 256> UnitManager::GetUnitsOfType(
    UnitType type) noexcept {
