...
void PlutoController::step_search() noexcept {
  ...
  // In a real swarm, this would explore possible Petri Net transitions (T1,
  // T2...) and push discovered nodes to scratch_nodes_ and tree_queue_.

  // [ZENITH PILLAR 1]: All node processing here is lock-free and
  // zero-allocation.
}

size_t PlutoController::get_search_tree(Mantis::AStarNode* out_nodes,
