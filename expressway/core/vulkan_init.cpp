 ...
 public:
  ...
  bool init() {
    ...
    if (vkCreateInstance(&createInfo, nullptr, &instance_) != VK_SUCCESS) {
      std::cerr << "[Expressway] Failed to create Vulkan instance!"
                << std::endl;
      return false;
    }
    ...
    if (vkCreateDevice(physical_device_, &deviceCreateInfo, nullptr,
                       &device_) != VK_SUCCESS) {
...
// Global entry point
extern "C" bool expressway_init() { return VulkanContext::instance().init(); }
