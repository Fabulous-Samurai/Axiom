...
QSGNode* AxiomExpresswayNode::updatePaintNode(QSGNode* oldNode, UpdatePaintNodeData* data) {
    if (!active_) {
        delete oldNode;
        return nullptr;
    }
...
void AxiomExpresswayNode::itemChange(ItemChange change, const ItemChangeData& data) {
