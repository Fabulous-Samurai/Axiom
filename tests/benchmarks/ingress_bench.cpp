...
static void BM_MockIngress(benchmark::State& state) {
    ...
    auto ingress = AXIOM::IngressFactory::create(AXIOM::IngressFactory::ProviderType::PROV_MOCK_HFT_FEED, "mock0");
    ingress->start(&arena);
...
static void BM_AFXDPIngress(benchmark::State& state) {
    ...
    auto ingress = AXIOM::IngressFactory::create(AXIOM::IngressFactory::ProviderType::PROV_AF_XDP, "eth0");
