...
int main(int argc, char *argv[]) {
  ...
  // Logic for mock mode or IPC connection can be handled inside the runner or
  // here. For now, keeping it simple.

  return app.run("qrc:/AxiomDashboard.qml",
                 "AXIOM Dashboard | System Flow Monitor");
}
