...
signals:
    /**
     * @brief Emitted when a new style update is successfully processed on the UI thread.
...
private:
    ...
    static constexpr int POLL_INTERVAL_MS = 8; // ~120Hz polling for sub-frame response
};
