...
enum class LayoutType : uint8_t {
    Column = 0, Row, Grid, Stack, Absolute
};

enum class ComponentType : uint8_t {
    Container = 0,
    Row, Column, Grid,
    GlassPanel, KPICard, Chart, Table,
    Sidebar, Navbar, Button, Gauge,
    Badge, Toast, Spacer, Text, Image,
    StatusIndicator, ModeBadge, ActionMenu
};

inline std::string_view componentTypeName(ComponentType t) {
    switch (t) {
        case ComponentType::Container: return "Container";
        case ComponentType::Row: return "Row";
        case ComponentType::Column: return "Column";
        case ComponentType::Grid: return "Grid";
        case ComponentType::GlassPanel: return "GlassPanel";
        case ComponentType::KPICard: return "KPICard";
        case ComponentType::Chart: return "Chart";
        case ComponentType::Table: return "Table";
        case ComponentType::Sidebar: return "Sidebar";
        case ComponentType::Navbar: return "Navbar";
        case ComponentType::Button: return "Button";
        case ComponentType::Gauge: return "Gauge";
        case ComponentType::Badge: return "Badge";
        case ComponentType::Toast: return "Toast";
        case ComponentType::Spacer: return "Spacer";
        case ComponentType::Text: return "Text";
        case ComponentType::Image: return "Image";
        case ComponentType::StatusIndicator: return "StatusIndicator";
        case ComponentType::ModeBadge: return "ModeBadge";
        case ComponentType::ActionMenu: return "ActionMenu";
