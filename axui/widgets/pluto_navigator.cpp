...
void PlutoSwarmNode::update(const QRectF&, size_t count, const QPointF* positions, const uint32_t* parent_ids) {
...
PlutoSwarmNavigator::PlutoSwarmNavigator(QQuickItem* parent) : QQuickItem(parent) {
...
QSGNode* PlutoSwarmNavigator::updatePaintNode(QSGNode* oldNode, UpdatePaintNodeData*) {
